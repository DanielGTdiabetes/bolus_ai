...
from app.services.restaurant import analyze_menu_with_gemini, compare_plate_with_gemini, RestaurantPlateResult, RestaurantMenuResult
...
async def compare_plate(
    ...
    try:
        return await compare_plate_with_gemini(content, image.content_type, expected_carbs)
    except RuntimeError as exc:
