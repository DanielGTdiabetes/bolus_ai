...
## Flujo Actual de Administración de Bolos

Este flujo aplica tanto a iOS como a Android, aunque el proyecto está en una migración de iOS a Android:

1. Antes de la comida, el usuario abre MyFitnessPal e introduce los alimentos.
2. MyFitnessPal facilita la entrada porque conserva alimentos recientes y tiene un lector de códigos de barras eficaz.
3. Al cerrar MyFitnessPal, el cierre de la app se detecta y se envía una señal a Hermes Agent.
4. Hermes Agent consulta la web de MyFitnessPal mediante el MCP de FitnessPal, usando cookies ya configuradas, y extrae los nutrientes.
5. Los nutrientes extraídos se envían al NAS, donde corre Bolus AI en Docker/Portainer.
6. Bolus AI calcula el bolo con su calculadora a partir de hidratos, proteínas, grasas y fibra.
7. La recomendación se envía al bot de Telegram, que muestra el bolo calculado.
8. Desde Telegram, el usuario puede aceptar, editar o cancelar la recomendación.
9. Cuando el bolo se acepta, se indica el lugar recomendado de inyección, actualmente el estómago.
10. En paralelo, otro bot detecta la comida y recomienda un tiempo de espera estimado según los alimentos introducidos.
11. El sistema va creando una base de datos de alimentos y bolos para aprendizaje y seguimiento.

**Componentes externos relevantes:**
- MyFitnessPal como interfaz principal de entrada de alimentos.
- Hermes Agent como automatización que detecta el cierre de MyFitnessPal y dispara la consulta.
- MCP de FitnessPal para extraer nutrientes desde la web de MyFitnessPal.
- Telegram como canal de confirmación, edición y cancelación del bolo.

**Notas de implementación:**
- No asumir que el origen móvil será siempre iOS; cualquier integración nueva debe contemplar Android como destino principal de la migración.
