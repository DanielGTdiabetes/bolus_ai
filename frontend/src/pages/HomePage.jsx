    ...
    return (
        <section className="card glucose-hero" style={{
            ...
            <div style={{ width: '100%', marginTop: '1rem' }}>
                <MainGlucoseChart isLow={isLow} predictionData={prediction} historyHours={2} />
            </div>
            ...
            <div
                style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.75rem', color: '#94a3b8', textDecoration: 'underline', cursor: 'pointer', padding: '10px' }}
