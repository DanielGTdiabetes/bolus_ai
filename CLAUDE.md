...
- El modo Restaurante/Carta y sus rutas ya no forman parte del producto.
- El modo Microbolos y `ignore_iob` están retirados y no pueden saltarse el IOB.
- Las comidas consecutivas se calculan con el motor general: el IOB protege la corrección positiva y no consume hidratos nuevos.
